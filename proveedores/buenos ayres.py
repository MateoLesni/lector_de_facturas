...
** Codigo: Corresponde a "CODIGO" del texto del OCR. Es el primer campo.
** Producto: Corresponde a "DETALLE" de cada producto. Es el tercer campo.
** Cantidad: Corresponde a los valores de la columna "BULTOS/UNID." Debes traer el numero tal cual te lo brinda el OCR.
...
- "Cantidad Gem" → es la segunda columna llamada "BULTOS/UNID."
