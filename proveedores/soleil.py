...
** Codigo: pon 0.
** Producto: Corresponde a "Producto / Servicio" (segunda columna) de cada producto.
** Cantidad: Corresponde a los valores de la columna "Cantidad", la cual nos brinda información de cuantas unidades compramos.
...
Columnas:
- "Código Gem" pon 0.
- "Producto Gem" → es la segunda columna, llamada "Producto / Servicio"
- "Cantidad Gem" → es la tecer columna, llamada "Cantidad". 
