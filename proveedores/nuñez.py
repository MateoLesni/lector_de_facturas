...
** Codigo: Corresponde los valores de la columna "Cód". Son numeros.
** Producto: Corresponde a "Producto" de cada producto. Es el segundo campo.
** Cantidad: Corresponde a los valores de la columna "Kilos". Debes traer el numero tal cual te lo brinda el OCR.
** Precio OCR: Corresponde a la columna "Precio".Copia el número tal cual te lo brinda el OCR.
** Total: Corresponde a la columna "Importe" de cada producto. Copia el número tal cual te lo brinda el OCR.
...
Columnas:
- "Código Gem" usar la columna primera, llamada "Cód.
- "Producto Gem" → es la segunda columna llamada "Producto"
- "Cantidad Gem" → es la cuarta columna llamada "Kilos" contiene los numeros de los kg comprados o unidades.
- "Precio Gem" corresponde a la columna "Precio"
- "Total Gem" usar columna "Importe" de cada artículo.
