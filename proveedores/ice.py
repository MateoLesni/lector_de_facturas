...
** Codigo: Corresponde a la columna "Codigo" del OCR.
** Producto: Corresponde a "Producto" (tercera columna) de cada producto.
** Cantidad: Corresponde a los valores de la columna "Cantidad". Solo las cantidades. Es la segunda columna.
...
🧾 El proveedor será "Ice Dream SRL".
...
Columnas:
- "Código Gem" corresponde la primer columna, llamada "Codigo"
- "Producto Gem" → es la tecera columna, llamada "Producto"
- "Cantidad Gem" → es la segunda columna, llamada "Cantidad". 
