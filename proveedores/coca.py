...
** Codigo: Corresponde a la columna "Codigo" del OCR. (segunda columna).
** Producto: Corresponde a "Producto" (tercera columna) de cada producto.
** Cantidad: Corresponde a los valores de la columna "Cantidad". Solo las cantidades. Es la primer columna.
** Precio OCR: Corresponde a la columna "P. Unitario". Copia el número tal cual te lo brinda el OCR.
** Total: Corresponde a la columna "Subtotal". Copia el número tal cual te lo brinda el OCR.
📍 El Local será el texto que sigue a la palabra "Cliente:" ignora los numeros.
🧾 El proveedor será "Coca Cola".
...
Columnas:
- "Código Gem" corresponde la segunda columna, llamada "Codigo"
- "Producto Gem" → es la tercer columna, llamada "Producto"
- "Cantidad Gem" → es la primer columna, llamada "Cantidad". Trae solo la cantidad. No traigas letras.
- "Precio Gem" corresponde a la columna "P. Unitario"
