...
** Cantidad: Corresponde a los valores de la columna "Cantidad"(primer columna), la cual nos brinda información de cuantas unidades compramos. No incluyas separador de miles.
** Precio OCR: Corresponde a la columna "Precio s/Impuestos" (sexta columna) Copia el número tal cual te lo brinda el OCR.
...
🧾 El proveedor será "Distribuidoras DBA".
