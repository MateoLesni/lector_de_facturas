...
** Codigo: Corresponde a la columna "Articulo" del OCR.
** Producto: Corresponde a "Descripción" (segunda columna) de cada producto.
** Cantidad: Corresponde a los valores de la columna "Cantidad". Solo las cantidades. Es la tercera columna. Los números de las cantidades están en formato "2,00" sólo quiero el numero, no traigas otra cosa.
** Precio OCR: Corresponde a la columna "P. Unitario". Copia el número tal cual te lo brinda el OCR.
** Total: Corresponde a la columna "Neto". Copia el número tal cual te lo brinda el OCR.
📍 El Local será el texto que sigue a la palabra "Cliente:"
🧾 El proveedor será "Axionlog".
...
Columnas:
- "Código Gem" corresponde la primer columna, llamada "Artículo"
