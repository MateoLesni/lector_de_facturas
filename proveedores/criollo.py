...
** Codigo: El proveedor no tiene código. Pon 0.
** Producto: Corresponde a "Descripción" de cada producto. Es el tercer campo.
** Cantidad: Corresponde a los valores de la columna "Cant./KG" Debes traer el numero tal cual te lo brinda el OCR.
** Precio OCR: Corresponde a la columna "P.U.".Copia el número tal cual te lo brinda el OCR.
...
🧾 El proveedor será "Distribuidora el Criollo".
...
Columnas:
- "Código Gem" pon 0. El proveedor no tiene códigos en la factura.
- "Producto Gem" → es la segunda columna llamada "Descripción"
- "Cantidad Gem" → es la tercera columna llamada "Cant./KG" contiene los numeros de los kg comprados o unidades.
- "Precio Gem" corresponde a la columna "P.U."
