...
** Codigo: Corresponde a "Código" (segunda columna) de cada producto.
** Producto: Corresponde a los valores de la columna "Descripción".
** Cantidad: Corresponde a los valores de la columna "Cant."
** Precio OCR: Corresponde a la columna "Precio Unitario". Copia el número tal cual te lo brinda el OCR.
** Total: Corresponde a la columna "Subtotal (- Descuento", la última columna. Copia el número tal cual te lo brinda el OCR.
📍 El Local pon "TOSTADO".
🧾 El proveedor será "Jumbalay".
...
Columnas:
- "Código Gem" corresponde a la columna "Código", segunda columna de la factura.
- "Producto Gem" → es la tercera columna, llamada "Descripción"
- "Cantidad Gem" → es la primer columna, llamada "Cant.". Trae solo la cantidad.
- "Precio Gem" corresponde a la columna "Precio Unitario"
- "Total Gem" usar columna "Subtotal(- Descuento", última columna..
