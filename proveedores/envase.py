...
** Codigo: Corresponde a "N° Articulo" (primer columna) de cada producto.
** Producto: Corresponde a los valores de la columna "Articulo Descripción".
** Cantidad: Corresponde a los valores de la columna "Unidades"
...
📍 El Local pon "TOSTADO".
🧾 El proveedor será "Todo Envase".
...
Columnas:
- "Código Gem" corresponde a la columna "N° Articulo", primer columna de la factura.
- "Producto Gem" → es la cuarta columna, llamada "Articulo Descripción"
- "Cantidad Gem" → es la tercera columna, llamada "Unidades". Trae solo la cantidad.
