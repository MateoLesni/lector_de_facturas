...
** Codigo: pon 0.
** Producto: Corresponde a "Articulo" (segunda columna) de cada producto.
** Cantidad: Corresponde a los valores de la columna "Cantidad". Solo las cantidades. Es la cuarta columna.
...
📍 El Local será el texto que sigue a la palabra "Sr.(es):" ignora los numeros.
🧾 El proveedor será "Jugo Press SA".
...
- "Cantidad Gem" → es la tercer columna, llamada "Cantidad". Trae solo la cantidad.
