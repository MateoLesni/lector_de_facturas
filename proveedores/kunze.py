...
** Cantidad: Corresponde a los valores de la columna "Cantidad" la cual nos brinda información de cuantas unidades compramos. No incluyas separador de miles.
** Precio OCR: Corresponde a la columna "Precio". Copia el número tal cual te lo brinda el OCR.
** Total: Corresponde a la columna "Subtotal". Es sin impuestos, quiere decir que está antes del '21%'. Copia el número tal cual te lo brinda el OCR.
