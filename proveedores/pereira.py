...
** Codigo: Corresponde los valores de la columna "Código". Son numeros.
** Producto: Corresponde a "Descripción" de cada producto. Es el segundo campo.
** Cantidad: Corresponde a los valores de la columna "Cantidad". Debes traer el numero tal cual te lo brinda el OCR.
** Precio OCR: Corresponde a la columna "I.Unitario".Copia el número tal cual te lo brinda el OCR.
** Total: Corresponde a la columna "Total S/Imp." de cada producto. Copia el número tal cual te lo brinda el OCR.
📍 El Local será el texto que sigue a la palabra "Razon social:"
🧾 El proveedor será "Pereira".
...
Columnas:
- "Código Gem" usar la columna primera, llamada "Código".
- "Producto Gem" → es la segunda columna llamada "Descripción"
- "Cantidad Gem" → es la tercera columna llamada "Cantidad" contiene los numeros de los kg comprados o unidades.
- "Precio Gem" corresponde a la columna "I.Unitario"
- "Total Gem" usar columna "Total S/Imp." de cada artículo.
...
"132","Barritas de submarino Aguila Caja (24 x 14 gr)","1","14946,31","14946,31"
"134","Queso Crema Milka ut Balde x 3.6 Kg","2","40698,53","81397,05"
"145","Rebozador Preferido Bolsa x 5 Kg","1","8961,05","8961,05"
Imagen: {download_url}
'''
